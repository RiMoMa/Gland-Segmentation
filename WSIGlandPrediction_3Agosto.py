...
def process_all_images(path_folder, patchsize, batch_size, HighResol, ImgNormalize,OutputFolder):
    ...
    start_from = '210_042_2021_he.svs'
    ...
    for svs_file in svs_files_to_process:#svs_files:
       ...
       # MetaplasiaPredsCase = MetaplasiaPreds.loc[case_name]
        ...
        ####################################################################
        FolderOutSVS = '/media/ssdCi/PredictedSVS'
...
# Uso de la función
path_folder = '/GastricFinished/Buenas/'
OutputDataset = '/media/ricardo/Datos/DatasetPatchesBuenas/'
patchsize = (512*4, 512*4)
batch_size = 50
HighResol = False
ImgNormalize = True
